## This project is a fork of [MicroLauncher](https://github.com/Yuyuko1024/MicroLauncher) and it uses icons from [Delta-Icons pack](https://github.com/Delta-Icons/android)

# F25Launcher
**F25launcher** is a custom launcher for the OEM **APS F25** model and its derivatives.
While it was specifically developed for the **SAIET Link 4 Pro**, it should also work on devices like **Fysic F25**, **Opel Touchflip**, **TTFone T970**, etc.
...
### APP Drawer
![Alt text](Screenshots/Drawer.png?raw=true "Optional Title")

### Launcher settings
![Alt text](Screenshots/Settings1.png?raw=true "Optional Title")

![Alt text](Screenshots/Settings2.png?raw=true "Optional Title")
